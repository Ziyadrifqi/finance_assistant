...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[var(--background)]">
      {/* Sidebar desktop - kolom terpisah, hanya tampil di md ke atas */}
      ...
      {/* Drawer mobile - overlay penuh layar, di luar alur flex row */}
      {mobileOpen && (
      ...
      {/* Kolom konten utama: top bar mobile (di dalam kolom yang sama, di ATAS children) + children */}
